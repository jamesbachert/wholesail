...
const SIGNAL_DETAIL_CONFIG: Record<string, { detailType: InlineDetailType; datePlaceholder?: string; textPlaceholder?: string }> = {
  ...
  upset_sale:          { detailType: 'date_and_text', datePlaceholder: 'Sale date', textPlaceholder: 'Upset amount or details...' },
...
const CATEGORIES = [
  {
    ...
    icon: AlertTriangle,
    color: '#ef4444',
    signals: ['pre_foreclosure', 'probate', 'tax_delinquent', 'upset_sale', 'divorce', 'code_violation', 'liens_judgments'],
  },
  {
    key: 'ownership',
    label: 'Ownership',
...
const FALLBACK_WEIGHTS: Record<string, { label: string; weight: number; category: string }> = {
  ...
  upset_sale:          { label: 'Upset Sale',                weight: 25, category: 'distress' },
  divorce:             { label: 'Divorce – Recent Filing or Finalized', weight: 28, category: 'distress' },
  ...
  inherited:           { label: 'Inherited Property',         weight: 25, category: 'ownership' },
  ...
  high_equity:         { label: 'High Equity',               weight: 16, category: 'financial' },
